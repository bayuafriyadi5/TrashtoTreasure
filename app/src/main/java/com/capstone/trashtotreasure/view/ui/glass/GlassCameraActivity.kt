...
import com.capstone.trashtotreasure.databinding.ActivityGlassCameraBinding
...
@AndroidEntryPoint
class GlassCameraActivity : AppCompatActivity() {

    private lateinit var binding: ActivityGlassCameraBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGlassCameraBinding.inflate(layoutInflater)
    ...
    private fun proceedPicture(photoFile: File) {
        ...
        intent.putExtra(GlassResultActivity.EXTRA_PICTURE, photoFile)
        intent.putExtra(
            GlassResultActivity.EXTRA_IS_BACK_CAMERA,
