...
import com.capstone.trashtotreasure.model.data.remote.response.getTransaksiByPembeli.PayloadItem
...
class MyTransactionPembeliAdapter (private val productsList: List<PayloadItem?>) :
    RecyclerView.Adapter<MyTransactionPembeliAdapter.AdsViewHolder>()  {
        ...
        fun bind(myTransactionItem: PayloadItem) {
            ...
            binding.root.setOnClickListener {
                ...
                if (myTransactionItem.idTransaksi != null) {
                    val intent = Intent(context, DetailTransactionPembeliActivity::class.java).apply {
